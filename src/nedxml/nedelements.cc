...
const char *ConnectionElement::getAttributeName(int k) const
{
    switch (k) {
        ...
        case 12: return "name";
        case 13: return "type";
        case 14: return "like-type";
        case 15: return "like-expr";
        case 16: return "is-default";
        case 17: return "is-bidirectional";
        case 18: return "is-forward-arrow";
        default: return 0;
    }
}
...
const char *ConnectionElement::getAttribute(int k) const
{
    switch (k) {
        ...
        case 12: return name.c_str();
        case 13: return type.c_str();
        case 14: return likeType.c_str();
        case 15: return likeExpr.c_str();
        case 16: return boolToString(isDefault);
        case 17: return boolToString(isBidirectional);
        case 18: return boolToString(isForwardArrow);
        default: return 0;
    }
}
...
void ConnectionElement::setAttribute(int k, const char *val)
{
    switch (k) {
        ...
        case 12: name = val; break;
        case 13: type = val; break;
        case 14: likeType = val; break;
        case 15: likeExpr = val; break;
        case 16: isDefault = stringToBool(val); break;
        case 17: isBidirectional = stringToBool(val); break;
        case 18: isForwardArrow = stringToBool(val); break;
        default: ;
    }
}
