...
#line 595 "ned1.y"
    {
                  ...
                  addExpression(ps.submod, "vector-size",ps.exprPos,(yyvsp[(4) - (5)]));
...
#line 607 "ned1.y"
    {
                  ...
                  ps.submod->setLikeExpr(toString((yylsp[(3) - (6)]))); //TODO store as expression
...
#line 619 "ned1.y"
    {
                  ...
                  ps.submod->setLikeExpr(toString((yylsp[(3) - (7)]))); //TODO store as expression
                  addExpression(ps.submod, "vector-size",ps.exprPos,(yyvsp[(4) - (7)]));
...
#line 764 "ned1.y"
    {
                  ...
                  addExpression(ps.gatesize, "vector-size",ps.exprPos,(yyvsp[(2) - (2)]));
...
#line 959 "ned1.y"
    {
                  ...
                  addExpression(ps.conn, "src-module-index",ps.exprPos,(yyvsp[(2) - (2)]));
                }
    break;
...
#line 977 "ned1.y"
    {
                  ...
                  addExpression(ps.conn, "src-gate-index",ps.exprPos,(yyvsp[(2) - (2)]));
                }
    break;
...
#line 1028 "ned1.y"
    {
                  ...
                  addExpression(ps.conn, "dest-module-index",ps.exprPos,(yyvsp[(2) - (2)]));
                }
    break;
...
#line 1040 "ned1.y"
    {
                  ...
                  addExpression(ps.conn, "dest-gate-index",ps.exprPos,(yyvsp[(2) - (2)]));
                }
    break;
...
#line 1083 "ned1.y"
    {
                  ps.conn->setType(toString((yylsp[(1) - (1)])));
                }
    break;
...
/* Line 1806 of yacc.c  */
#line 1138 "ned1.y"
    { (yyval) = (yyvsp[(2) - (3)]); ps.exprPos = (yylsp[(2) - (3)]); }
    break;
