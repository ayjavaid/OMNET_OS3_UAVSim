...
void PingTestApp::initialize(int stage)
{
    ...
    if (stage == 0)
    {
        ...
        WATCH(numPongs);
        //cout << "loss count :" << lossCount;                      // added by farha Jahan for debugging 06.08.2014
    ...
    else if (stage == 3)
    {
        ...
        //cout <<"Node status" << nodeStatus;                        // added by farha Jahan for debugging 06.08.2014
        isOperational = (!nodeStatus) || nodeStatus->getState() == NodeStatus::UP;
        //cout << "isOperational:" << isOperational <<endl;       // added by farha Jahan for debugging 06.08.2014
        if (!isOperational)
...
void PingTestApp::sendToICMP(cMessage *msg, const IPvXAddress& destAddr, const IPvXAddress& srcAddr, int hopLimit)
{
    ...
    if (!destAddr.isIPv6())
    {
        ...
        send(msg, "pingOut");
        cout << "Reached Icmp out"<<msg <<endl;;
#else
